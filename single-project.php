...
<section id="portfolio-projects">
      <div class="container">
        ...
        <div class="info">
          <div class="buttons">
            <a href="<?php echo $project_url; ?>" target="_blank"><i class="fas fa-desktop"></i> View Project</a>
            <a class="github-button" href="<?php echo $github_url; ?>" target="_blank"><i class="fas fa-code"></i> View Code</a>
          </div>
        </div>
